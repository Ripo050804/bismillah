...
# ==============================================
# DESKRIPSI KELAS
# (diupdate: monolit → Lesung_batu sesuai skripsi)
# ==============================================
DESKRIPSI_KELAS = {
    ...
    "Lesung_batu": "Lesung batu adalah artefak batu yang memiliki cekungan besar pada permukaannya. Digunakan sebagai alat tradisional untuk menumbuk atau menghaluskan bahan makanan pada masa prasejarah."
}

# ==============================================
# KONFIGURASI GOOGLE DRIVE
# FILE_ID diambil dari link:
# https://drive.google.com/file/d/1hRmWsJ8EmqINdMG1GCTuTjLdOfWr3JOx/view
# ==============================================
        ...
        with st.spinner("🔄 Mendownload model (96 MB) dari Google Drive..."):
            try:
                ...
                try:
                    ...
                    # Handle konfirmasi virus scan Google Drive
...
def load_class_names():
    try:
        ...
        # Default sesuai skripsi (7 kelas, tanpa monolit)
...
def load_model_info():
    try:
        ...
        # Nilai aktual dari hasil evaluasi skripsi
        return {
...
with tab2:
    ...
    st.json({
        ...
        "best_val_accuracy_phase2": f"{model_info['best_val_accuracy_phase2']:.2%}",
        "test_loss": f"{model_info.get('test_loss', 0.7564):.4f}",
        "test_auc": f"{model_info.get('test_auc', 0.9990):.4f}",
        "format": "TFLite (float32)",
        "ukuran_file": "96.5 MB",
        "fase_terbaik": "Phase 2 - Fine Tuning"
    })
...
<div style="text-align: center; color: #666; padding: 1rem;">
    <p>Aplikasi Klasifikasi Batu Megalitikum Pagar Alam<br>
    ResNet50 Transfer Learning | Akurasi 97.35% | 7 Kelas<br>
    © 2025 - Penelitian Skripsi</p>
</div>
""", unsafe_allow_html=True)
